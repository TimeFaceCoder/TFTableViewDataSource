...
- (ASLayoutSpec *)layoutSpecThatFits:(ASSizeRange)constrainedSize {
    switch (self.tableViewItem.cellStyle) {
        case UITableViewCellStyleDefault:
        {
            ...
            if (_imageNode) {
                ...
                if (_imageNode.image.size.height > constrainedSize.max.height) {
                    _imageNode.style.preferredSize = CGSizeMake(constrainedSize.max.height, constrainedSize.max.height);
                }
        ...
        case UITableViewCellStyleValue1: {
            _detailNode.style.flexGrow = 1.0;
            ...
            if (textWidth<contentWidth) {
                _detailNode.style.flexShrink = 1.0;
            }
            else {
                _textNode.style.flexShrink = 1.0;
            }           
        ...
        case UITableViewCellStyleSubtitle: {
            ...
            contentVSpec.style.flexShrink = 1.0;
            NSMutableArray *children = [NSMutableArray array];
            if (_imageNode) {
                if (_imageNode.image.size.height > constrainedSize.max.height) {
                    _imageNode.style.preferredSize = CGSizeMake(constrainedSize.max.height, constrainedSize.max.height);
