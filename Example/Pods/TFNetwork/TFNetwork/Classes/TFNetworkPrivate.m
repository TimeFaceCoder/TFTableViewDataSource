...
@implementation TFNetworkPrivate
...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        TFNLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation TFBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<TFRequestAccessory> accessory in self.requestAccessories) {
...
@implementation TFBatchRequest (RequestAccessory)
...
@implementation TFChainRequest (RequestAccessory)
